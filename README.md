...
Сверстать холст размером на весь экран, но не меньше 800х600c. При клике на холст должны добавляться точки, которые соединены между собой линиями. Точки можно передвигать. Линии перестраиваются автоматически. При клике на первую точку фигура должна замыкаться. Как только фигура замкнута, при клике на холст начинается построение новой фигуры.
